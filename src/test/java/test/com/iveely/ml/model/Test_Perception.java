...
public class Test_Perception {
    ...
    public void testPerception() {
        ...
        featureDataList.add(new FeatureData<>(0.0,new Double[]{1.0, 0.0}));
        featureDataList.add(new FeatureData<>(1.0,new Double[]{1.0, 1.0}));
        featureDataList.add(new FeatureData<>(0.0,new Double[]{0.0, 0.0}));
        featureDataList.add(new FeatureData<>(0.0,new Double[]{0.0, 1.0}));
